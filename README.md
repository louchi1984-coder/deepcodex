...
| Windows | beta / preview | `deepcodex-windows-v0.1.31-appearance-settings-fix.zip` |
...
1. 下载 `deepcodex-windows-v0.1.31-appearance-settings-fix.zip`
2. 解压
...
下载 `deepcodex-windows-v0.1.31-appearance-settings-fix.zip`，解压后双击：
